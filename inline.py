...
async def run_inline():
    ...
    def build_ads_menu(session_name):
        ...
        buttons = [
            ...
            [Button.inline("➕ ارسال بنر جدید", data=b"adv_new")],
        ...
        try:
            ...
            if d == "adv_toggle":
                ...
                if not ads.get("banner_type"):
                    await event.answer(
                        "❌ ابتدا باید بنر ارسال کنید!", alert=True
                    )
                    return
            ...
            if d == "adv_new":
                ...
                text = (
                    "➕ **ارسال بنر جدید**\n\n"
                    "برای ارسال بنر، باید به **ربات اصلی** بروید.\n\n"
                    "**مراحل:**\n"
                    "1️⃣ روی دکمه زیر کلیک کنید\n"
                    "2️⃣ بنر خود را ارسال کنید (متن، عکس، فیلم، فایل)\n"
                    "3️⃣ فاصله زمانی را مشخص کنید\n"
                    "4️⃣ حالت ارسال (فوروارد/عادی) را انتخاب کنید\n\n"
                    "💡 **نکته:** اگر قبلاً بنر داشتید، جایگزین می‌شود."
                )
                buttons = [
                    [Button.url("🤖 برو به ربات اصلی", bot_url)],
                    [Button.inline("⬅️ بازگشت", data=b"adv_menu")],
                ]
                await event.edit(text, buttons=buttons)
